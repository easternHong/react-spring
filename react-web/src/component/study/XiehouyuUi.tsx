...
import {Tts, TTsContent} from "../../model/Tts.tsx";
import {StudyApi} from "../../vm/StudyApi.tsx";

export default function XiehouyuUi() {
    ...
    return (
        <div className='bg-red-100 p-4 w-full flex-column text-center flex-wrap justify-center'>
            <div className={'mt-20 h-1/5 text-6xl text-cyan-900'}> {current?.riddle}</div>
